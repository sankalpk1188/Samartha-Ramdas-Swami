            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-default">
                        <form method="POST" action="{{ url('admin/add-career') }}" enctype="multipart/form-data" id="addBanner">@csrf <div class="card-body">
                                <div class="form-group col-md-10">
                                    <div class="form-group col-md-10">
                                        <label class="required">Image <small>(Size: 55x50px)</small></label>
...
<script>
    $(document).ready(function() {
        $('#addBanner').validate({
            ...
            messages: {
                title: {
                    required: "Please enter no more than 25 characters.",   
                },
                description: {
