        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <!-- <div class="col-sm-6 text-right">
                    <a href="{{ url('/admin/add-vision') }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Add </a>
                </div> -->
            </div>
        </div>
    </section>
    <section class="content">
        <div class="container-fluid"> @if(Session::has('flash_message_error')) 
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped" style="overflow-x: auto;">
                                        ...
                                        <tr>
                                            <td>{{ $loop->index+1 }}</td>
                                            <td>{!! Str::limit($row->vision,20)!!}</td>
                                            <td>{!! Str::limit($row->mission,20)!!}</td>
                                            <td>{{date('d F Y', strtotime($row->updated_at)) }}</td>
                                            <td>
                                                <a class="btn btn-default" id="editAbout" href="{{ url('/admin/edit-vision/'.$row->id) }}" title="Edit Stats">
