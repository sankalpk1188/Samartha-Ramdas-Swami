            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 text-right">
                        <a href="{{ url('/admin/add-literature') }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i>
                            Add Literature</a>
                    </div>
                </div>
            </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped" style="overflow-x: auto;">
                                    ...
                                    <tbody>
                                        @foreach ($literature as $row)
                                            <tr>
                                                <td>{{ $loop->index + 1 }}</td>
                                                <td><a href="{{ asset('assets/imgs/literature/' . $row->image) }}"><img
                                                            src="{{ asset('assets/imgs/literature/' . $row->image) }}"
                                                            width="100px"></a></td>
                                                ...
                                                <td>
                                                    <a class="btn btn-default" id="editAbout"
                                                        href="{{ url('/admin/edit-literature/' . $row->id) }}"
                                                        title="Edit Literature"><i class="fa fa-edit"
                                                            style="color: #000;"></i></a> &nbsp;&nbsp;
                                                    <a class="btn btn-danger" onclick="return confirm('Are you sure?')"
                                                        href="{{ url('/admin/delete-literature/' . $row->id) }}"><i
